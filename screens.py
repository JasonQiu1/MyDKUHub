...
class ShowMyProgressScreen(Screen):
    ...
    def draw(self):
        ...
        next_screen, args = self.prompt()  # Capture the return value of prompt()
        return next_screen, args  # Pass it to the session to navigate to another screen
    ...
    def prompt(self):
        ...
        elif user_choice[0] == "4":  # Return to Home Screen
            return ScreenType.HOME, (self.session.user_level,)
